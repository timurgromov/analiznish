...
- «Фотушка» остаётся отдельным `market_reference`; «КАДРА» оценивается как наш будущий продукт без переноса чужой выручки, аудитории и маржи.
...
| Рыночная возможность v0.7 | 72 | `round(0.60*83 + 0.40*56) = 72`. Ниже референса «Фотушка» (`75`), потому что его работающая экономика и канал нельзя переносить в наш проект. |
