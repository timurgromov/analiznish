...
Главный продукт проекта — управляемый агентом `niche_factory`: он начинает без
готовой идеи, находит направления, сокращает их до одной конкретной ставки и
ведёт её через реальные клиентские сигналы, действие и деньги до решения о build.
