...
6. Только выбранная владельцем ставка проходит глубокое исследование, реальный CustDev, тест оффера
   и paid-pilot gate.
7. Только после build gate допускается полноценный MVP.
8. Карточки, эксперименты, рейтинг и project memory обновляются по ходу цикла.
