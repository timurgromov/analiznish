...
6. Если объединяются несколько завершённых runs, общий gate при пустых
   ...
   Владелец выбирает рабочий пакет из 1–3 проектов и назначает одну текущую
   работу; остальные готовые ставки не считаются проигравшими.
...
На экране решений четыре итоговые группы кликабельны. «Готовы к интервью»
показывает весь пул ставок с завершёнными S0–S5. «Нужно уточнить ставку»
