...
6. Если объединяются несколько завершённых runs, Global Portfolio Gate при
   пустых очередях оставляет максимум три предварительных финалиста. Это не три
   проекта к разработке: владелец выбирает ровно одну ставку.
7. Только выбранная владельцем ставка проходит глубокое исследование, реальный CustDev, тест оффера
   и paid-pilot gate.
...
На экране решений четыре итоговые группы кликабельны. Группа «вне текущего
соревнования» отдельно показывает идеи, завершившие desk research, остановленные
ранним Portfolio Gate и не прошедшие S2–S3; hard blockers остаются отдельным
исходом.
