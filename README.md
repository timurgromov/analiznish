...
приблизительный класс `A/B/C/X` относительно цели B2B-подписки
`1 000–5 000 ₽/мес` и пути к `100–1 000` плательщикам. Это помогает не терять
...
3. Все новые идеи сначала попадают в упорядоченное чистилище; верхний batch из
   5–10 кандидатов проходит публичный `S · SCAN 0–3`.
4. До интервью обязателен ранний Portfolio Gate: 18 критериев, hard filters,
   приблизительная ёмкость и 1–2 финалиста.
