...
- [x] Запустить новый чат фразой «Хочу искать нишу» и заполнить hunting constraints.
  - Выполнено 2026-09-09: B2B РФ, доступ к психологам РПП, жена-практик и потенциальный экспертный дистрибьютор; подробный лимит чека и цикла сделки остаётся уточнить до deep research.
- [x] Сформировать candidate universe из 5–10 направлений.
  - Выполнено 2026-09-09: общий CRM и общий AI-копайлот исключены как переполненные; Rule24 остаётся отдельным существующим активом; выбраны три конкретные РПП-ставки с плательщиком и референсом.
- [x] Провести 3–5 `quick_scan`.
  - Выполнено 2026-09-09: созданы три E1-карточки с hard filters, рисками и экспериментами; перед deep research выбрать одну через пять интервью с покупателями.
