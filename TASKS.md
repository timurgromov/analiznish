...
- [ ] Провести `S0–S3` для активного legacy-портфельного batch.
  - 2026-09-12: `S0_CONTEXT`–`S2_TREND` завершены. PastLife AI / Sansara
    отсеян на `S2_TREND`: exact-offer «прошлая жизнь по фото» не получил двух
    независимых свежих signals. Радарыч, КАДРА, AI YouTube Automation,
    ассистент по женскому циклу и ProfiWatcher находятся на `S3_LOCALIZE` в
    `data/discovery/2026-09-11-legacy-portfolio-sigma-run.md`.
