...
- [x] Встроить transaction-first поиск через marketplaces готовых бизнесов.
  - Выполнено 2026-09-10: добавлен отдельный protocol для Acquire.com, Flippa,
    ...
    разведены. Пилот по mental wellness сохранён без изменения hit parade.
...
- [ ] Провести 5 problem interviews по финалисту C.
  - Acceptance: каждый участник имеет минимум 3 новых обращения за последние
    90 дней и свободные слоты; разобраны три последних обращения; одна точка
    потери повторилась минимум у трёх, сохранены противоречащие случаи.
