...
- [ ] Провести `S0–S3` для активного legacy-портфельного batch.
  - Старт 2026-09-11: Радарыч, КАДРА, AI YouTube Automation, ассистент по
    женскому циклу, PastLife AI / Sansara и ProfiWatcher выровнены на
    `S0_CONTEXT` в `data/discovery/2026-09-11-legacy-portfolio-sigma-run.md`.
