...
- [x] Перестроить dashboard v3 в единый кабинет всех идей.
  ...
  - Уточнено 2026-09-13: все четыре итоговые карточки открывают состав группы;
    `20 вне текущего соревнования` разделены на `6` завершивших desk research,
    `9` остановленных ранним Portfolio Gate и `5` не прошедших S2–S3. Два hard
    blocker показаны отдельно.
