...
- [ ] Завершить S1 для восстановленного Codex Project Starter.
  - Текущий gate: минимум три независимые платные модели практического
    AI-перехода/внедрения; по каждой видны плательщик, трансформация, delivery и
    граница evidence. Это одна ставка, а не набор продуктов.
...
- [ ] Закрыть Portfolio Closure существующих assets.
  - Исправлено 2026-09-13: Rule24 прошёл S0–S5, но не мог получить
    `passed_not_selected` по execution score без owner decision; он parked до
    следующего evidence gate. Closure остаётся открытым: B2B batch требуется
    довести с S2 до S4, затем сравнить независимые ставки.
