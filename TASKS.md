...
ставок готовы к интервью, 3 требуют уточнить Thesis Contract, 2 имеют hard
...
- [x] Перестроить dashboard v3 в единый кабинет всех идей.
  ...
  - Исправлено 2026-09-13: все четыре итоговые карточки открывают состав группы;
    верхний экран показывает `20 готовы к интервью / 3 уточнить ставку / 2 hard
    blocker / 3 reference`. Пул готовности отделён от пакета 1–3 и одной текущей
    работы.
...
- [x] Пересмотреть Portfolio Closure без искусственной квоты финалистов.
  - Выполнено 2026-09-13: 20 ставок прошли S0–S5 и готовы к интервью; 3 требуют
...
- [ ] Собрать новый S0 batch только при пустом Portfolio Closure.
  - Acceptance: owner не оставил surviving finalist без решения либо выбранный
    ...
    до записи в реестр.
- [ ] Сформировать рабочий пакет интервью из 1–3 готовых проектов.
