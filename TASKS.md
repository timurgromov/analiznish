...
- [ ] Завершить `S · SCAN 2 — Разведка` для трёх Jobs психологов.
  - Acceptance: датированная динамика и живые обсуждения по работе после
    сессии, ведению практики и получению/удержанию клиентов; переносимость на РФ
    обозначена; `ACTIVE_RUN` переведён на этап 3 только после gate.
