...
- [ ] Закрыть Portfolio Closure существующих assets до нового discovery.
  - Acceptance: Rule24 проходит Factory v2 S0–S3 без shortcut за готовый код;
    затем зафиксирован либо failed, либо finalist для общего owner choice.
    Действующий свадебный бизнес и market reference не подменяют кандидатов.
- [ ] Собрать новый S0 batch только после пустого Portfolio Closure.
  - Acceptance: ни один surviving finalist не ожидает owner choice; каждый
    новый кандидат имеет заранее наблюдаемый локальный сегмент и пересечение
    минимум двух независимых входов до записи в реестр.
