...
* Первый factory-run перезапущен 2026-09-09 в направлении частных психологов:
  ...
  уже полученного лида, но не подтверждает их боль. `ACTIVE_RUN` фиксирует один
  следующий gate: этап 6 — независимый голос 5–10 практиков о последних
  ситуациях, обходах и последствиях; только потом аудитория/JTBD и INSIGHT.
