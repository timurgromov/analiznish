...
Текущий этап: рабочая docs-first система с `Niche Discovery Loop v1.0`, локальным Docker dashboard и двумя независимыми портфельными представлениями: карта рынков/референсов и очередь конкретных ставок.
