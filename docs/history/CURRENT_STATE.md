...
* Первый factory-run перезапущен 2026-09-09 в направлении частных психологов:
  ...
  обсуждения. `ACTIVE_RUN` фиксирует один следующий gate: этап 3 — локализовать
  все три Jobs через Wordstat, ручные альтернативы, данные и доступные
  вакансии/объявления; затем фильтрация и только после неё голос клиента/INSIGHT.
