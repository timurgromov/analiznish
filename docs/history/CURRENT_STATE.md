...
* Первый factory-run перезапущен 2026-09-09 в направлении частных психологов:
  ...
  нейтральное приглашение, guide и kill criteria; реальных интервью ещё нет.
  `ACTIVE_RUN` фиксирует один следующий gate: минимум пять подходящих разговоров
  и повтор одного паттерна у трёх участников; только потом аудитория/JTBD и
  INSIGHT.
