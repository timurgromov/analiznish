...
В `IDEA_INBOX` и единый registry добавлен `Codex Project Starter — запуск
цифрового проекта без команды`: адаптированный starter pack, короткие уроки и
маршрут от идеи до проектных документов, GitHub и первого ограниченного deploy.
Это `concrete_bet / inbox / not_researched / E0 0.25`, класс `B`, осторожный
текущий рейтинг `55`.
