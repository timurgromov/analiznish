...
новый фокус. Целевая модель отбора — B2B-подписка `1 000–5 000 ₽/мес` с путём
к `100–1 000` плательщикам и MRR `100 000–5 000 000 ₽/мес`.
...
целевой B2B-подписной модели. Запись не создаёт обязательство, полный score или
строку hit parade.
...
| 3. Early Portfolio Gate | Какие конкретные модели быстро отсеять до интервью? | 18-критериальный quick scan 5–10 кандидатов, hard filters, ёмкость и 1–2 финалиста | Решение о deep research |
