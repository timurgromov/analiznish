...
```text
Model note: GPT-5.6 Sol/Высокий — нужен исследовательский контур, работа с источниками и экономикой бизнес-ставок.
...
Считай главной целью устойчивую прибыль, а повторяемый cashflow — сильным
преимуществом, но не hard filter. B2B-подписка `1 000–5 000 ₽/мес` и путь к
`100–1 000` плательщикам — benchmark micro-SaaS; также сравнивай сильный B2C,
комиссию/транзакции, разовый прибыльный продукт и актив для продажи по прибыли,
скорости денег, повторяемости, риску и стоимости запуска. Все новые
идеи сначала заземляй в `data/IDEA_INBOX.md` по
`docs/IDEA_PURGATORY_PROTOCOL.md`.

Затем коротко уточни мои hunting constraints: B2B/B2C, допустимые модели денег, география,
