...
const criterionLabels = {
  ...
  eighteen_criteria_visible: "Все 18 критериев видимы", market_economics_moat_separated: "Рынок, экономика и защита разделены", unknowns_visible: "Неизвестные явно показаны", top_one_or_two: "Desk-критерии пройдены",
