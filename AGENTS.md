...
16. До реальных интервью обязателен ранний gate по 18 критериям из
    ...
    в общий пул готовых к интервью; скоринг задаёт порядок и стоимость
    проверки, но не искусственный лимит победителей. Если владелец принёс одну
    ...
    готовых проектов и назначает ровно одну текущую работу; интервью можно
    проводить последовательно по всем проектам пакета. Недостаточно определённая
